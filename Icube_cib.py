...
import sys
sys.path.append(mypaths['sidesdir']+'PYSIDES/pysides')
from gen_fluxes import *
...
class make_Icube_cib():
    ...
    def make_cib_cube(self, SED_file=mypaths['sidesdir']+'PYSIDES/pysides/SEDfiles/SED_finegrid_dict.p',
                      verbose = 1):
        '''
        ...
        for ix in range(self.Nx):
            for iy in range(self.Ny):
                ...
                Snu_arr = gen_Snu_arr(self.lambda_bins, SED_dict, redshift, LIR, Umean, DL, issb)
